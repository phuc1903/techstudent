...
function CoursesHighlyRated({ courses }) {
    ...
    const renderMainContent = () => (
        <div className="grid gap-6">
            ...
            <div className="grid gap-6">
                ...
                <div className="w-full md:w-[130px] h-12">
                    <Button
                        position="to"
    ...
    const renderMainSkeleton = () => (
        <div className="animate-pulse grid gap-12 bg-white">
            <div className="h-[200px] md:h-[300px] lg:h-[340px] bg-gray-300 rounded-md"></div>
            <div className="grid gap-6">
    ...
    const renderCourseNewContent = () => (
        <div className="grid gap-6">
            {coursesNew.slice(0, 3).map((course) => (
                <div
                    key={course.id}
                    className="grid grid-cols-12 gap-6 md:grid-cols-7 lg:grid-cols-7"
                >
                    <div className="col-span-12 md:col-span-3 h-[150px] md:h-[200px] relative">
                        <Image
                        ...
                        <Button
                            ...
                            iconPosition="left"
                            classes="absolute items-center rounded-[4px] bottom-[10px] right-[10px] md:bottom-[26px] md:right-[26px]"
                        >
                            5.0
                        </Button>
                    </div>
                    <div className="col-span-12 md:col-span-4">
                        <div className="flex flex-col justify-between h-full">
                            ...
                            <div className="w-full md:w-[104px] h-10 mt-4 md:mt-0">
                                <Button
        ...
        <div className="grid gap-6">
            {Array(3)
                ...
                .map((_, index) => (
                    <div
                        key={index}
                        className="animate-pulse bg-white grid grid-cols-12 md:grid-cols-7 gap-6"
                    >
                        <div className="col-span-3 h-[150px] md:h-[200px] bg-gray-300 rounded-sm"></div>
