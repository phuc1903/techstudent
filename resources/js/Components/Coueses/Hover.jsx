...
function Hover({ course, show = false }) {
    const [heart, setHeart] = useState(false);
    return (
        <div
            className={classNames("absolute top-1/2 right-[-12px] z-[9999]", {
                block: show,
                hidden: !show,
            })}
        >
            ,
            <div className="relative w-[424px] bg-white z-50 py-6 mx-auto border-[1px] border-gray-100 after:content-[''] after:absolute after:top-1/2 after:left-[-20px] after:border-[10px] after:border-transparent after:border-r-white">
