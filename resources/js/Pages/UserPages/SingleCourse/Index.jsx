...
const features = [
    ...
    },
    {
        ...
        titleRight: "Beginner and Intermediate",
    },
    {
        id: 3,
        icon: (
                            ...
                            <div className="grid grid-cols-12 gap-6">
                                <div className="col-span-8 flex flex-col gap-6 pt-[80px] pb-[32px]">
                                    <h3 className="heading-03 text-gray-900">
                                        Complete Website Responsive Design: from
                                        Figma to Webflow to Website Design
                                    </h3>
                                    <span className="body-xxl-400 text-gray-700">
                                        3 in 1 Course: Learn to design websites
                                        with Figma, build with Webflow, and make
                ...
                <div className="bg-white">
                    <div className="width-container mx-auto">
                        <div className="grid grid-cols-12 gap-6">
                                ...
                                <div className="grid gap-10">
                                    <div className="w-full h-[492px]">
                                        <iframe
                                            width="100%"
                                            height="100%"
                                            src="https://www.youtube.com/embed/VnSi-yPMPME"
                                            title="Dự án mẫu - thiết kế web | Bài 06: Lập trinh php mysql, thiết kế CSDL database | Thầy Hộ Fpoly HCM"
                                            frameBorder="0"
                            ...
                            <div className="col-span-4 flex flex-col gap-6 border py-6">
