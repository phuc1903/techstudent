...
function Navbar() {
    ...
    const navigation = [
        ...
        {
            id: 2,
            active: route().current("instructor.course.create"),
            href: route("instructor.course.create"),
        ...
        {
            id: 3,
            active: route().current("instructor.course.index"),
    ...
    return (
        <div className="flex flex-col justify-between pb-6 bg-gray-900 h-full">
